...
mapgroupproto.xml - Standard Cherna lootfile telling what buildings to spawn loot in, but copied in the underground bunker and roadblock info from the Livonia file, seeing as Cherna doesn't normally have underground nor roadblock objects.

"custom" folder with ChernaBunker.json - Spawns in the many buildings and rocks used in the custom build.
...
It is currently under development and you can join the xbox server "bunker of doom" to see how it looks.
